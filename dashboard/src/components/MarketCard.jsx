...
const MarketCard = ({ asset, symbol, supplyApy, borrowApy, liquidity, logo }) => {
    return (
        <div className="glass-panel p-6 border-slate-800 hover:border-slate-700 transition-all group">
            ...
            <div className="flex gap-3">
                <button className="flex-1 bg-blue-600 hover:bg-blue-500 text-white py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2">
